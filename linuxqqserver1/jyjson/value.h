...
public:
	...
	/* data */
   // bool virtual clean();//清理整个valueArr对象
protected:
...
struct TypeValue:public Value
{
  ...
  //  operator const char*()const;
   ...
   // TypeValue& operator=(ValueObj*);
   //TypeValue& operator=(ValueArr*);
...
public:
	...
	ValueObj(){};
	~ValueObj();
	ValueObj(const ValueObj &org);//复制和赋值
...
public:
	ValueArr(){};
	~ValueArr();
	ValueArr(const ValueArr &org);//复制和赋值
